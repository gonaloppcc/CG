...
void prepareCylinder(float height, float radius, int sides) {
    float *v;
    float *n;
    ...
    for (int i = 0; i < sides; ++i) {
        ...
        vertex++;
        v[vertex * 3 + 0] = radius * sinf(i * delta);
        v[vertex * 3 + 1] = height / 2.0f;
        v[vertex * 3 + 2] = radius * cosf(i * delta);
        ...
        vertex++;
        v[vertex * 3 + 0] = radius * sinf((i + 1) * delta);
        v[vertex * 3 + 1] = height / 2.0f;
        v[vertex * 3 + 2] = radius * cosf((i + 1) * delta);
...
void initGL() {
    ...
    GLfloat dark_green[4] = {0.1, 0.3, 0.1, 1.0};
    GLfloat green[4] = {0.3, 0.8, 0.3, 1.0};

    // light colors
    glLightfv(GL_LIGHT0, GL_AMBIENT, dark_green);
